...
if(DEFINED ENV{LEMON_CXX_WARNING})
  ...
  elseif(MSVC)
    ...
    # keep it as an example. Suppressed warnings:
    list(
      APPEND
      CXX_WARNING
...
if(LEMON_ENABLE_GLPK AND GLPK_FOUND)
...
if(LEMON_ENABLE_ILOG AND ILOG_FOUND)
  set(LEMON_HAVE_LP ON)
  set(LEMON_HAVE_MIP ON)
...
if(LEMON_ENABLE_COIN AND COIN_FOUND)
  set(LEMON_HAVE_LP ON)
  set(LEMON_HAVE_MIP ON)
...
if(LEMON_ENABLE_SOPLEX AND SOPLEX_FOUND)
  set(LEMON_HAVE_LP ON)
